...
def process():
    logger.info("TestbindUpushDeviceToken.py process~~~")#记录日志
    logger.info('baseUrl is :' + ENV.getBaseUrl())#记录日志
    send_data = "deviceToken=86ff036c0d43d99a6ca0e68049d98e00edd1787794bd65782aae4e66a0c18d76";
    #send_data_urlencode = urllib.urlencode(send_data);
    send_data_bytes = bytes(send_data,encoding='utf8')

    requrl = ENV.getBaseUrl() + "/api/bindUpushDeviceToken";#拼接首页的URL
